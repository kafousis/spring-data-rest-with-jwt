...
public class SwaggerConfig {
    ...
    public OpenAPI openAPI() {
        ...
        return new OpenAPI()
                .info(new Info().title("Spring Data REST with JWT")
                        .description("Spring Boot project that shows how to build and secure a RESTful API using Spring Data REST and Spring Security.")
                        .version("v0.0.1")
                        .contact(new Contact().name("Giannis Kafousis").email("g.kafousis@gmail.com").url("https://www.linkedin.com/in/gkafousis/")))

                .externalDocs(new ExternalDocumentation()
                        .description("Spring Data REST with JWT documentation")
                        .url("https://github.com/kafousis/spring-data-rest-with-jwt"))
